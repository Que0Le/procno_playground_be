...
async def create_new_topic(
    ...
    topic_db = crud.topic.get_combi_by_topic_uniq_id(
...
def get_own_topic_overviews(
    ...
    """
    topics_db = crud.topic.get_combi_by_user_id(
...
def delete_topic_and_related_by_uniq_id(
    *,
    ...
    answer_combi_s = crud.answer.get_combi_by_topic_uniq_id(
    ...
    nbr_topics_answer_deleted = crud.topic_answer.remove_by_topic_uniq_id(
        db=db, topic_uniq_id=str(topic_db.t_uniq_id)
    )
    # Delete in answers
    ...
    # Delete tag topic
    tag_topic_s = crud.tag_topic.remove_by_topic_uniq_id(
        db=db, topic_uniq_id=str(topic_db.t_uniq_id)
    )
    print(tag_topic_s)
    # Delete topic
